...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Social.facebook_id'
        db.add_column('notify_social', 'facebook_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Social.facebook_id'
        db.delete_column('notify_social', 'facebook_id')
