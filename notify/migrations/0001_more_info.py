...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('notify_fax', (
            ('id', orm['notify.Fax:id']),
            ('site', orm['notify.Fax:site']),
            ('timestamp', orm['notify.Fax:timestamp']),
            ('page_count', orm['notify.Fax:page_count']),
            ('transaction', orm['notify.Fax:transaction']),
        ))
