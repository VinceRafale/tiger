...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fax.destination'
        db.add_column('notify_fax', 'destination', orm['notify.fax:destination'])
        
        # Adding field 'Fax.completion_time'
        db.add_column('notify_fax', 'completion_time', orm['notify.fax:completion_time'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Fax.destination'
        db.delete_column('notify_fax', 'destination')
        
        # Deleting field 'Fax.completion_time'
        db.delete_column('notify_fax', 'completion_time')
    ...
    models = {
        ...
        'notify.fax': {
            'completion_time': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
