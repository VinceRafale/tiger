...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SmsSettings.reseller_network'
        db.add_column('sms_smssettings', 'reseller_network', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SmsSettings.reseller_network'
        db.delete_column('sms_smssettings', 'reseller_network')
