...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SMS.subscriber'
        db.alter_column('sms_sms', 'subscriber_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.SmsSubscriber'], null=True))


    def backwards(self, orm):
        
        # Changing field 'SMS.subscriber'
        db.alter_column('sms_sms', 'subscriber_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['sms.SmsSubscriber']))
