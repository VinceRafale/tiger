...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.body'
        db.alter_column('sms_campaign', 'body', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'Thread.body'
        db.alter_column('sms_thread', 'body', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'SmsSettings.intro_sms'
        db.alter_column('sms_smssettings', 'intro_sms', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))

        # Changing field 'SMS.body'
        db.alter_column('sms_sms', 'body', self.gf('django.db.models.fields.CharField')(max_length=140))


    def backwards(self, orm):
        
        # Changing field 'Campaign.body'
        db.alter_column('sms_campaign', 'body', self.gf('django.db.models.fields.CharField')(max_length=160))

        # Changing field 'Thread.body'
        db.alter_column('sms_thread', 'body', self.gf('django.db.models.fields.CharField')(max_length=160))

        # Changing field 'SmsSettings.intro_sms'
        db.alter_column('sms_smssettings', 'intro_sms', self.gf('django.db.models.fields.CharField')(max_length=160, null=True))

        # Changing field 'SMS.body'
        db.alter_column('sms_sms', 'body', self.gf('django.db.models.fields.CharField')(max_length=160))
