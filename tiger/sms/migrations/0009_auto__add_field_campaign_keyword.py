...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Campaign.keyword'
        db.add_column('sms_campaign', 'keyword', self.gf('django.db.models.fields.CharField')(default='', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Campaign.keyword'
        db.delete_column('sms_campaign', 'keyword')
