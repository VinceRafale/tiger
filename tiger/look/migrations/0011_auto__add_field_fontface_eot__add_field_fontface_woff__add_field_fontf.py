...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FontFace.eot'
        db.add_column('look_fontface', 'eot', self.gf('django.db.models.fields.files.FileField')(default=1, max_length=100), keep_default=False)

        # Adding field 'FontFace.woff'
        db.add_column('look_fontface', 'woff', self.gf('django.db.models.fields.files.FileField')(default=1, max_length=100), keep_default=False)

        # Adding field 'FontFace.svg'
        db.add_column('look_fontface', 'svg', self.gf('django.db.models.fields.files.FileField')(default=1, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FontFace.eot'
        db.delete_column('look_fontface', 'eot')

        # Deleting field 'FontFace.woff'
        db.delete_column('look_fontface', 'woff')

        # Deleting field 'FontFace.svg'
        db.delete_column('look_fontface', 'svg')
