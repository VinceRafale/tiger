...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skin.site'
        db.add_column('look_skin', 'site', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.Site'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skin.site'
        db.delete_column('look_skin', 'site_id')
