...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FontFace.stack'
        db.alter_column('look_fontface', 'stack', self.gf('django.db.models.fields.TextField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'FontFace.stack'
        db.alter_column('look_fontface', 'stack', self.gf('django.db.models.fields.CharField')(max_length=255))
