...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Skin.body_font'
        db.alter_column('look_skin', 'body_font', self.gf('django.db.models.fields.TextField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Skin.body_font'
        db.alter_column('look_skin', 'body_font', self.gf('django.db.models.fields.CharField')(max_length=255))
