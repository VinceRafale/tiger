...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skin.body_color'
        db.add_column('look_skin', 'body_color', self.gf('django.db.models.fields.CharField')(default='000000', max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skin.body_color'
        db.delete_column('look_skin', 'body_color')
