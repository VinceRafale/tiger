...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Background.staged_image'
        db.add_column('look_background', 'staged_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Background.staged_image'
        db.delete_column('look_background', 'staged_image')
    ...
    models = {
        ...
        'look.skin': {
            ...
            'header_font': ('django.db.models.fields.related.ForeignKey', [], {'default': '4', 'to': "orm['look.FontFace']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
