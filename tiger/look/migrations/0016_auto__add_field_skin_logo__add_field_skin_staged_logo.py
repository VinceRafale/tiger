...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('look_skin', 'logo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['look.Logo'], null=True, blank=True), keep_default=False)

        # Adding field 'Skin.staged_logo'
        db.add_column('look_skin', 'staged_logo', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='temporary_skins', null=True, to=orm['look.Logo']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skin.logo'
        db.delete_column('look_skin', 'logo_id')

        # Deleting field 'Skin.staged_logo'
        db.delete_column('look_skin', 'staged_logo_id')
    ...
    models = {
        ...
        'look.skin': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['look.Logo']", 'null': 'True', 'blank': 'True'}),
            ...
            'site': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['accounts.Site']", 'unique': 'True', 'null': 'True'}),
            'staged_logo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'temporary_skins'", 'null': 'True', 'to': "orm['look.Logo']"}),
