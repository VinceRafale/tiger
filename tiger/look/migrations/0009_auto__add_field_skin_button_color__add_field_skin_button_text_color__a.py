...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skin.button_color'
        db.add_column('look_skin', 'button_color', self.gf('django.db.models.fields.CharField')(default='C76218', max_length=6), keep_default=False)

        # Adding field 'Skin.button_text_color'
        db.add_column('look_skin', 'button_text_color', self.gf('django.db.models.fields.CharField')(default='f7f7f7', max_length=6), keep_default=False)

        # Adding field 'Skin.shaded_color'
        db.add_column('look_skin', 'shaded_color', self.gf('django.db.models.fields.CharField')(default='bfccd1', max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skin.button_color'
        db.delete_column('look_skin', 'button_color')

        # Deleting field 'Skin.button_text_color'
        db.delete_column('look_skin', 'button_text_color')

        # Deleting field 'Skin.shaded_color'
        db.delete_column('look_skin', 'shaded_color')
    ...
    models = {
        ...
        'look.skin': {
            ...
            'body_font': ('django.db.models.fields.CharField', [], {'default': '\'Frutiger, "Frutiger Linotype", Univers, Calibri, "Gill Sans", "Gill Sans MT", "Myriad Pro", Myriad, "DejaVu Sans Condensed", "Liberation Sans", "Nimbus Sans L", Tahoma, Geneva, "Helvetica Neue", Helvetica, Arial, sans-serif\'', 'max_length': '255'}),
