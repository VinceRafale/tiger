...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('look_background', 'repeat', self.gf('django.db.models.fields.CharField')(max_length=9, blank=True))

        # Changing field 'Background.name'
        db.alter_column('look_background', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))

        # Changing field 'Background.color'
        db.alter_column('look_background', 'color', self.gf('django.db.models.fields.CharField')(max_length=6, blank=True))

        # Changing field 'Background.attachment'
        db.alter_column('look_background', 'attachment', self.gf('django.db.models.fields.CharField')(max_length=7, blank=True))

        # Changing field 'Background.position'
        db.alter_column('look_background', 'position', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Background.name'
        db.alter_column('look_background', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Background.color'
        db.alter_column('look_background', 'color', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'Background.attachment'
        db.alter_column('look_background', 'attachment', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'Background.position'
        db.alter_column('look_background', 'position', self.gf('django.db.models.fields.CharField')(max_length=20))
