...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skin.staged_pre_base'
        db.add_column('look_skin', 'staged_pre_base', self.gf('django.db.models.fields.TextField')(default='\n<div class="wrapper">\n    <div id="masthead">\n        <div class="container_12">\n            <div id="menu" class="grid_8">\n            {% block logo %}{% endblock %}\n            </div>\n            <div id="search" class="grid_4">\n            <h4>Menu search</h4>\n            {% block search %}{% endblock %}\n            </div>\n        </div> \n    </div>\n    <div id="menuWrap">\n        <div class="container_12">\n            <div id="menu" class="grid_8">\n            {% block menu %}{% endblock %}\n            </div>\n            <div class="grid_4">\n            </div>\n        </div> \n    </div>\n    <div id="content" class="container_12">\n        <div id="mainWrap" class="grid_8 alpha">\n        <div id="main">\n        {% block messages %}{% endblock %}\n\n        {% block content %}{% endblock %}\n        </div>\n        </div>\n        <div id="sidebarWrap" class="grid_4 omega">\n        <div id="sidebar">\n            {% block cart %}{% endblock %}\n\n            {% block sections %}{% endblock %}\n\n            {% block contact %}{% endblock %}\n\n            {% block pdf %}{% endblock %}\n\n            {% block social %}{% endblock %}\n\n            {% block mail %}{% endblock %}\n        </div>\n        </div>\n    </div>\n<div class="shim"></div>\n</div>\n<div class="footer">\n    <div class="container_12">\n        {% block footer %}\n        {% endblock %}\n    </div> \n</div>\n'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skin.staged_pre_base'
        db.delete_column('look_skin', 'staged_pre_base')
    ...
    models = {
        ...
        'look.skin': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'pre_base': ('django.db.models.fields.TextField', [], {'default': '\'\\n<div class="wrapper">\\n    <div id="masthead">\\n        <div class="container_12">\\n            <div id="menu" class="grid_8">\\n            {% block logo %}{% endblock %}\\n            </div>\\n            <div id="search" class="grid_4">\\n            <h4>Menu search</h4>\\n            {% block search %}{% endblock %}\\n            </div>\\n        </div> \\n    </div>\\n    <div id="menuWrap">\\n        <div class="container_12">\\n            <div id="menu" class="grid_8">\\n            {% block menu %}{% endblock %}\\n            </div>\\n            <div class="grid_4">\\n            </div>\\n        </div> \\n    </div>\\n    <div id="content" class="container_12">\\n        <div id="mainWrap" class="grid_8 alpha">\\n        <div id="main">\\n        {% block messages %}{% endblock %}\\n\\n        {% block content %}{% endblock %}\\n        </div>\\n        </div>\\n        <div id="sidebarWrap" class="grid_4 omega">\\n        <div id="sidebar">\\n            {% block cart %}{% endblock %}\\n\\n            {% block sections %}{% endblock %}\\n\\n            {% block contact %}{% endblock %}\\n\\n            {% block pdf %}{% endblock %}\\n\\n            {% block social %}{% endblock %}\\n\\n            {% block mail %}{% endblock %}\\n        </div>\\n        </div>\\n    </div>\\n<div class="shim"></div>\\n</div>\\n<div class="footer">\\n    <div class="container_12">\\n        {% block footer %}\\n        {% endblock %}\\n    </div> \\n</div>\\n\''}),
            ...
            'staged_pre_base': ('django.db.models.fields.TextField', [], {'default': '\'\\n<div class="wrapper">\\n    <div id="masthead">\\n        <div class="container_12">\\n            <div id="menu" class="grid_8">\\n            {% block logo %}{% endblock %}\\n            </div>\\n            <div id="search" class="grid_4">\\n            <h4>Menu search</h4>\\n            {% block search %}{% endblock %}\\n            </div>\\n        </div> \\n    </div>\\n    <div id="menuWrap">\\n        <div class="container_12">\\n            <div id="menu" class="grid_8">\\n            {% block menu %}{% endblock %}\\n            </div>\\n            <div class="grid_4">\\n            </div>\\n        </div> \\n    </div>\\n    <div id="content" class="container_12">\\n        <div id="mainWrap" class="grid_8 alpha">\\n        <div id="main">\\n        {% block messages %}{% endblock %}\\n\\n        {% block content %}{% endblock %}\\n        </div>\\n        </div>\\n        <div id="sidebarWrap" class="grid_4 omega">\\n        <div id="sidebar">\\n            {% block cart %}{% endblock %}\\n\\n            {% block sections %}{% endblock %}\\n\\n            {% block contact %}{% endblock %}\\n\\n            {% block pdf %}{% endblock %}\\n\\n            {% block social %}{% endblock %}\\n\\n            {% block mail %}{% endblock %}\\n        </div>\\n        </div>\\n    </div>\\n<div class="shim"></div>\\n</div>\\n<div class="footer">\\n    <div class="container_12">\\n        {% block footer %}\\n        {% endblock %}\\n    </div> \\n</div>\\n\''}),
