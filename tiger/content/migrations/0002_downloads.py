...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PdfMenu.featured'
        db.add_column('content_pdfmenu', 'featured', orm['content.pdfmenu:featured'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'PdfMenu.featured'
        db.delete_column('content_pdfmenu', 'featured')
