...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Content.showcase'
        db.add_column('content_content', 'showcase', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='showcased_content_set', null=True, to=orm['content.ItemImage']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Content.showcase'
        db.delete_column('content_content', 'showcase_id')
