...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PdfMenu.page_count'
        db.add_column('content_pdfmenu', 'page_count', orm['content.pdfmenu:page_count'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'PdfMenu.page_count'
        db.delete_column('content_pdfmenu', 'page_count')
