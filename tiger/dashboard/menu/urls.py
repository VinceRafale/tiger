...
urlpatterns = patterns('tiger.dashboard.menu.views',
    ...
    url(r'^sections/(\d+)/hours/$', 'section_hours', name='dashboard_edit_section_hours'),
    url(r'^item/delete/(\d+)/$', 'delete_item', name='dashboard_delete_item'),
    url(r'^items/reorder/$', 'reorder_items', name='dashboard_reorder_items'),
    ...
    url(r'^(section|item)/edit/(\d+)/options/$', 'add_edit_menu_options', name='dashboard_edit_options'),
