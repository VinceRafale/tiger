...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notify_fax', (
            ...
            ('page_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('parent_transaction', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('transaction', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('completion_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('notify', ['Fax'])

        # Adding model 'SMS'
        db.create_table('notify_sms', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('destination', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('logged', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('notify', ['SMS'])

        # Adding model 'Social'
        db.create_table('notify_social', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.Site'], unique=True)),
            ('twitter_screen_name', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('twitter_token', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('twitter_secret', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('twitter_auto_items', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('facebook_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('facebook_page_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('facebook_page_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('facebook_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('facebook_url', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('facebook_auto_items', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('mailchimp_api_key', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('mailchimp_list_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('mailchimp_list_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('mailchimp_allow_signup', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('mailchimp_send_blast', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mailchimp_from_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
        ))
        ...
        db.create_table('notify_release', (
            ...
            ('publish_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True)),
            ('fax_transaction', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('mailchimp', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Fax'
        db.delete_table('notify_fax')

        # Deleting model 'SMS'
        db.delete_table('notify_sms')
    ...
    models = {
        ...
        'notify.release': {
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
