...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Release.time_sent'
        db.delete_column('notify_release', 'time_sent')


    def backwards(self, orm):
        
        # Adding field 'Release.time_sent'
        db.add_column('notify_release', 'time_sent', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 4, 23)), keep_default=False)
