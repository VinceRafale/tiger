...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fax.logged'
        db.add_column('notify_fax', 'logged', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fax.logged'
        db.delete_column('notify_fax', 'logged')
