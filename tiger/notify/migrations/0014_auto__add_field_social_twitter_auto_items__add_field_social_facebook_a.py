...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Social.twitter_auto_items'
        db.add_column('notify_social', 'twitter_auto_items', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'Social.facebook_auto_items'
        db.add_column('notify_social', 'facebook_auto_items', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Social.twitter_auto_items'
        db.delete_column('notify_social', 'twitter_auto_items')

        # Deleting field 'Social.facebook_auto_items'
        db.delete_column('notify_social', 'facebook_auto_items')
