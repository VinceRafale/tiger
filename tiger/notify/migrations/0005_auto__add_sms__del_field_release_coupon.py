...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Release.coupon'
        db.delete_column('notify_release', 'coupon_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Release.coupon'
        db.add_column('notify_release', 'coupon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Coupon'], null=True, blank=True), keep_default=False)
