...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Social.mailchimp_allow_signup'
        db.add_column('notify_social', 'mailchimp_allow_signup', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Social.mailchimp_list_id'
        db.add_column('notify_social', 'mailchimp_list_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Social.mailchimp_list_name'
        db.add_column('notify_social', 'mailchimp_list_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Social.mailchimp_send_blast'
        db.add_column('notify_social', 'mailchimp_send_blast', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Social.mailchimp_api_key'
        db.add_column('notify_social', 'mailchimp_api_key', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Social.mailchimp_allow_signup'
        db.delete_column('notify_social', 'mailchimp_allow_signup')

        # Deleting field 'Social.mailchimp_list_id'
        db.delete_column('notify_social', 'mailchimp_list_id')

        # Deleting field 'Social.mailchimp_list_name'
        db.delete_column('notify_social', 'mailchimp_list_name')

        # Deleting field 'Social.mailchimp_send_blast'
        db.delete_column('notify_social', 'mailchimp_send_blast')

        # Deleting field 'Social.mailchimp_api_key'
        db.delete_column('notify_social', 'mailchimp_api_key')
    ...
    models = {
        ...
        'notify.blast': {
            'Meta': {'object_name': 'Blast'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_sent': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'pdf': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['content.PdfMenu']"}),
            'send_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Site']"}),
            'subscribers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['accounts.Subscriber']", 'symmetrical': 'False'})
        },
        'notify.fax': {
