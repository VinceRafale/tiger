...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Release.fax_transaction'
        db.add_column('notify_release', 'fax_transaction', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Release.fax_transaction'
        db.delete_column('notify_release', 'fax_transaction')
