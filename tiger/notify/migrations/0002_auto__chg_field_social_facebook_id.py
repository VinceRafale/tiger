...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Social.facebook_id'
        db.alter_column('notify_social', 'facebook_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Social.facebook_id'
        db.alter_column('notify_social', 'facebook_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
