...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notify_social', 'facebook_url', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Social.facebook_url'
        db.delete_column('notify_social', 'facebook_url')
    ...
    models = {
        ...
        'notify.blast': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Site']"}),
            'subscribers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['accounts.Subscriber']"})
        },
        'notify.fax': {
