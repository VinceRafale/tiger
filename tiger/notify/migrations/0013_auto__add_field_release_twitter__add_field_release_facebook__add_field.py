...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Release.twitter'
        db.add_column('notify_release', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Release.facebook'
        db.add_column('notify_release', 'facebook', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Release.mailchimp'
        db.add_column('notify_release', 'mailchimp', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Release.visible'
        db.add_column('notify_release', 'visible', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Release.twitter'
        db.delete_column('notify_release', 'twitter')

        # Deleting field 'Release.facebook'
        db.delete_column('notify_release', 'facebook')

        # Deleting field 'Release.mailchimp'
        db.delete_column('notify_release', 'mailchimp')

        # Deleting field 'Release.visible'
        db.delete_column('notify_release', 'visible')
