...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fax.parent_transaction'
        db.add_column('notify_fax', 'parent_transaction', orm['notify.fax:parent_transaction'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Fax.parent_transaction'
        db.delete_column('notify_fax', 'parent_transaction')
