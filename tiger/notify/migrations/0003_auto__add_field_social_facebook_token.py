...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Social.facebook_token'
        db.add_column('notify_social', 'facebook_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Social.facebook_token'
        db.delete_column('notify_social', 'facebook_token')
