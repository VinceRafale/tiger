...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('notify_blast', (
            ('id', orm['notify.blast:id']),
            ('site', orm['notify.blast:site']),
            ('name', orm['notify.blast:name']),
            ('pdf', orm['notify.blast:pdf']),
            ('last_sent', orm['notify.blast:last_sent']),
            ('send_count', orm['notify.blast:send_count']),
        ))
