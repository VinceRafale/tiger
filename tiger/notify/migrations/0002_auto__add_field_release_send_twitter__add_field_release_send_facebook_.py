...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Release.send_twitter'
        db.add_column('notify_release', 'send_twitter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Release.send_facebook'
        db.add_column('notify_release', 'send_facebook', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.add_column('notify_release', 'send_mailchimp', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.add_column('notify_release', 'send_fax', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Release.fax_list'
        db.add_column('notify_release', 'fax_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.FaxList'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Release.send_twitter'
        db.delete_column('notify_release', 'send_twitter')

        # Deleting field 'Release.send_facebook'
        db.delete_column('notify_release', 'send_facebook')

        # Deleting field 'Release.fax_list'
        db.delete_column('notify_release', 'fax_list_id')
    ...
    models = {
        ...
        'notify.release': {
            ...
            'fax_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.FaxList']", 'null': 'True'}),
            ...
            'send_facebook': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'send_twitter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
