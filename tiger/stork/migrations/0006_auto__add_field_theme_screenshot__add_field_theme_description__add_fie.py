...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Theme.screenshot'
        db.add_column('stork_theme', 'screenshot', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Theme.description'
        db.add_column('stork_theme', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Theme.notes'
        db.add_column('stork_theme', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Theme.screenshot'
        db.delete_column('stork_theme', 'screenshot')

        # Deleting field 'Theme.description'
        db.delete_column('stork_theme', 'description')

        # Deleting field 'Theme.notes'
        db.delete_column('stork_theme', 'notes')
