...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.theme'
        db.add_column('accounts_site', 'theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stork.Theme'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.theme'
        db.delete_column('accounts_site', 'theme_id')
