...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('accounts_site', 'domain', 'subdomain')

        # Deleting field 'Site.tld'
        db.delete_column('accounts_site', 'tld')

    
    def backwards(self, orm):

        # Deleting field 'Site.domain'
        db.rename_column('accounts_site', 'subdomain', 'domain')
        
        # Adding field 'Site.tld'
        db.add_column('accounts_site', 'tld', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)
