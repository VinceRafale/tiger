...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeSlot.schedule'
        db.alter_column('accounts_timeslot', 'schedule_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Schedule']))


    def backwards(self, orm):
        
        # Changing field 'TimeSlot.schedule'
        db.alter_column('accounts_timeslot', 'schedule_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Schedule'], null=True))
