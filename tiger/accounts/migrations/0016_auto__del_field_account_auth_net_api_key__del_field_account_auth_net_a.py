...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Account.auth_net_api_key'
        db.delete_column('accounts_account', 'auth_net_api_key')

        # Deleting field 'Account.auth_net_api_login'
        db.delete_column('accounts_account', 'auth_net_api_login')
    
    
    def backwards(self, orm):
        
        # Adding field 'Account.auth_net_api_key'
        db.add_column('accounts_account', 'auth_net_api_key', self.gf('django.db.models.fields.CharField')(default='foo', max_length=255, blank=True), keep_default=False)

        # Adding field 'Account.auth_net_api_login'
        db.add_column('accounts_account', 'auth_net_api_login', self.gf('django.db.models.fields.CharField')(default='foo', max_length=255, blank=True), keep_default=False)
