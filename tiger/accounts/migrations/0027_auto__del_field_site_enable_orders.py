...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site.enable_orders'
        db.delete_column('accounts_site', 'enable_orders')


    def backwards(self, orm):
        
        # Adding field 'Site.enable_orders'
        db.add_column('accounts_site', 'enable_orders', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
