...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_salesrep', (
            ('plan', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ...
        db.add_column('accounts_account', 'referrer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.SalesRep'], null=True), keep_default=False)
