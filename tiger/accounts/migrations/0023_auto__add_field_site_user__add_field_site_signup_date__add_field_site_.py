...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_site', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Adding field 'Site.signup_date'
        db.add_column('accounts_site', 'signup_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2011, 1, 26), blank=True), keep_default=False)

        # Adding field 'Site.managed'
        db.add_column('accounts_site', 'managed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.user'
        db.delete_column('accounts_site', 'user_id')

        # Deleting field 'Site.signup_date'
        db.delete_column('accounts_site', 'signup_date')

        # Deleting field 'Site.managed'
        db.delete_column('accounts_site', 'managed')
