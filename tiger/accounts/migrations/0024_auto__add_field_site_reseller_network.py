...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.reseller_network'
        db.add_column('accounts_site', 'reseller_network', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.reseller_network'
        db.delete_column('accounts_site', 'reseller_network')
