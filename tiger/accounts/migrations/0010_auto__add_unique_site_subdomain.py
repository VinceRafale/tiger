...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Site', fields ['subdomain']
        db.create_unique('accounts_site', ['subdomain'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Site', fields ['subdomain']
        db.delete_unique('accounts_site', ['subdomain'])
