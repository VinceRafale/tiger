...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site.hours'
        db.delete_column('accounts_site', 'hours')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Site.hours'
        db.add_column('accounts_site', 'hours', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)
