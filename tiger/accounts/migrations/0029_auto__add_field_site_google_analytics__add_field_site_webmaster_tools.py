...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_site', 'google_analytics', self.gf('django.db.models.fields.CharField')(max_length=30, null=True), keep_default=False)

        # Adding field 'Site.webmaster_tools'
        db.add_column('accounts_site', 'webmaster_tools', self.gf('django.db.models.fields.TextField')(max_length=255, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Site.webmaster_tools'
        db.delete_column('accounts_site', 'webmaster_tools')
