...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.mobile_on'
        db.add_column('accounts_site', 'mobile_on', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.mobile_on'
        db.delete_column('accounts_site', 'mobile_on')
