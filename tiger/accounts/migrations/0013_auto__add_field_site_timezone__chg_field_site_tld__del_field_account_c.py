...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_site', 'timezone', self.gf('django.db.models.fields.CharField')(default='America/New_York', max_length=100), keep_default=False)

        # Changing field 'Site.tld'
        db.alter_column('accounts_site', 'tld', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True))

        # Deleting field 'account.customer_profile_id'
        db.delete_column('accounts_account', 'customer_profile_id')

        # Deleting field 'account.payment_profile_id'
        db.delete_column('accounts_account', 'payment_profile_id')

        # Deleting field 'account.cc_last_4'
        db.delete_column('accounts_account', 'cc_last_4')
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Site.tld'
        db.alter_column('accounts_site', 'tld', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Adding field 'account.customer_profile_id'
        db.add_column('accounts_account', 'customer_profile_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'account.payment_profile_id'
        db.add_column('accounts_account', 'payment_profile_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'account.cc_last_4'
        db.add_column('accounts_account', 'cc_last_4', self.gf('django.db.models.fields.CharField')(default=1, max_length=16, blank=True), keep_default=False)
    ...
    models = {
        ...
        'accounts.site': {
            ...
            'timezone': ('django.db.models.fields.CharField', [], {'default': "'America/New_York'", 'max_length': '100'}),
            'tld': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
