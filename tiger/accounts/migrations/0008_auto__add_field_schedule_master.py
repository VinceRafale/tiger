...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Schedule.master'
        db.add_column('accounts_schedule', 'master', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Schedule.master'
        db.delete_column('accounts_schedule', 'master')
