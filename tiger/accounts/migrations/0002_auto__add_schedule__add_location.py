...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_schedule', (
            ...
            ('display', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        ...
        db.create_table('accounts_location', (
            ...
            ('zip_code', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
            ...
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Schedule'])),
        ...
        db.add_column('accounts_timeslot', 'schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Schedule'], null=True, blank=True), keep_default=False)
