...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScheduledUpdate.show_descriptions'
        db.add_column('accounts_scheduledupdate', 'show_descriptions', orm['accounts.scheduledupdate:show_descriptions'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ScheduledUpdate.show_descriptions'
        db.delete_column('accounts_scheduledupdate', 'show_descriptions')
