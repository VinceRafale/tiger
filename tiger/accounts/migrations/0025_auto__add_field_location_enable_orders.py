...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.enable_orders'
        db.add_column('accounts_location', 'enable_orders', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.enable_orders'
        db.delete_column('accounts_location', 'enable_orders')
