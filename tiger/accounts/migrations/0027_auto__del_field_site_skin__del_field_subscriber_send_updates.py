...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subscriber.send_updates'
        db.delete_column('accounts_subscriber', 'send_updates')


    def backwards(self, orm):
        
        # Adding field 'Site.skin'
        db.add_column('accounts_site', 'skin', self.gf('django.db.models.fields.related.ForeignKey')(default=11, to=orm['look.Skin']), keep_default=False)

        # Adding field 'Subscriber.send_updates'
        db.add_column('accounts_subscriber', 'send_updates', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
