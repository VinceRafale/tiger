...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.walkthrough_complete'
        db.add_column('accounts_site', 'walkthrough_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.walkthrough_complete'
        db.delete_column('accounts_site', 'walkthrough_complete')
