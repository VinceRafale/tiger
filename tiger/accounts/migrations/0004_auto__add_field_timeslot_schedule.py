...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TimeSlot.schedule'
        db.add_column('accounts_timeslot', 'schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Schedule'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TimeSlot.schedule'
        db.delete_column('accounts_timeslot', 'schedule_id')
