...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.credit_card'
        db.add_column('accounts_site', 'credit_card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.CreditCard'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.credit_card'
        db.delete_column('accounts_site', 'credit_card_id')
