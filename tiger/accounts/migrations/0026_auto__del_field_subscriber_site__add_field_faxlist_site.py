...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subscriber.site'
        db.delete_column('accounts_subscriber', 'site_id')

        # Adding field 'FaxList.site'
        db.add_column('accounts_faxlist', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Site']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Subscriber.site'
        db.add_column('accounts_subscriber', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Site']), keep_default=False)

        # Deleting field 'FaxList.site'
        db.delete_column('accounts_faxlist', 'site_id')
