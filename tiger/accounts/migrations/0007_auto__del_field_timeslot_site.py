...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TimeSlot.site'
        db.delete_column('accounts_timeslot', 'site_id')


    def backwards(self, orm):
        
        # Adding field 'TimeSlot.site'
        db.add_column('accounts_timeslot', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Site']), keep_default=False)
