...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.subscription_id'
        db.add_column('accounts_account', 'subscription_id', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'Account.customer_id'
        db.add_column('accounts_account', 'customer_id', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Changing field 'Account.fax'
        db.alter_column('accounts_account', 'fax', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True))

        # Changing field 'Account.phone'
        db.alter_column('accounts_account', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True))

        # Changing field 'Account.state'
        db.alter_column('accounts_account', 'state', self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2, null=True, blank=True))

        # Changing field 'Account.street'
        db.alter_column('accounts_account', 'street', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Account.subscription_id'
        db.delete_column('accounts_account', 'subscription_id')

        # Deleting field 'Account.customer_id'
        db.delete_column('accounts_account', 'customer_id')

        # Changing field 'Account.fax'
        db.alter_column('accounts_account', 'fax', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20))

        # Changing field 'Account.phone'
        db.alter_column('accounts_account', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20))

        # Changing field 'Account.state'
        db.alter_column('accounts_account', 'state', self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2))

        # Changing field 'Account.street'
        db.alter_column('accounts_account', 'street', self.gf('django.db.models.fields.CharField')(max_length=255))
