...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.require_sharing'
        db.add_column('core_coupon', 'require_sharing', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Coupon.view_count'
        db.add_column('core_coupon', 'view_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Coupon.twitter_share_count'
        db.add_column('core_coupon', 'twitter_share_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Coupon.fb_share_count'
        db.add_column('core_coupon', 'fb_share_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.require_sharing'
        db.delete_column('core_coupon', 'require_sharing')

        # Deleting field 'Coupon.view_count'
        db.delete_column('core_coupon', 'view_count')

        # Deleting field 'Coupon.twitter_share_count'
        db.delete_column('core_coupon', 'twitter_share_count')

        # Deleting field 'Coupon.fb_share_count'
        db.delete_column('core_coupon', 'fb_share_count')
    ...
    models = {
        ...
        'core.coupon': {
            ...
            'require_sharing': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
