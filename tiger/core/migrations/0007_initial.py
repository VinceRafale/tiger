...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_sidedish', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=5, decimal_places=2, blank=True)),
        ))
        ...
        db.create_table('core_order', (
            ...
            ('pickup', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('ready_by', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ...
        db.create_table('core_ordersettings', (
            ...
            ('lead_time', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('delivery_lead_time', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('delivery_area', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True)),
            ('payment_type', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
        ...
        db.create_table('core_coupon', (
            ...
            ('discount_type', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('dollars_off', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('percent_off', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
