...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SideDishGroup.item'
        db.alter_column('core_sidedishgroup', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Item'], null=True, blank=True))

        # Changing field 'SideDishGroup.section'
        db.alter_column('core_sidedishgroup', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Section'], null=True, blank=True))

        # Deleting field 'Upgrade.substitute'
        db.delete_column('core_upgrade', 'substitute')

        # Changing field 'Upgrade.item'
        db.alter_column('core_upgrade', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Item'], null=True, blank=True))

        # Changing field 'Upgrade.section'
        db.alter_column('core_upgrade', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Section'], null=True, blank=True))

        # Changing field 'Variant.item'
        db.alter_column('core_variant', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Item'], null=True, blank=True))

        # Changing field 'Variant.section'
        db.alter_column('core_variant', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Section'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'SideDishGroup.item'
        db.alter_column('core_sidedishgroup', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Item'], null=True))

        # Changing field 'SideDishGroup.section'
        db.alter_column('core_sidedishgroup', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Section'], null=True))

        # Adding field 'Upgrade.substitute'
        db.add_column('core_upgrade', 'substitute', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'Upgrade.item'
        db.alter_column('core_upgrade', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Item'], null=True))

        # Changing field 'Upgrade.section'
        db.alter_column('core_upgrade', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Section'], null=True))

        # Changing field 'Variant.item'
        db.alter_column('core_variant', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Item'], null=True))

        # Changing field 'Variant.section'
        db.alter_column('core_variant', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Section'], null=True))
