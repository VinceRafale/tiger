...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_coupon', 'percent_off', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))

        # Changing field 'Coupon.dollars_off'
        db.alter_column('core_coupon', 'dollars_off', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True))
        ...
        # Adding field 'Order.ready_by'
        db.add_column('core_order', 'ready_by', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Changing field 'Order.pickup'
        db.alter_column('core_order', 'pickup', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'Coupon.percent_off'
        db.alter_column('core_coupon', 'percent_off', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Coupon.dollars_off'
        db.alter_column('core_coupon', 'dollars_off', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))

        # Deleting field 'OrderSettings.lead_time'
        db.delete_column('core_ordersettings', 'lead_time')

        # Deleting field 'Order.ready_by'
        db.delete_column('core_order', 'ready_by')

        # Changing field 'Order.pickup'
        db.alter_column('core_order', 'pickup', self.gf('django.db.models.fields.CharField')(max_length=20))
