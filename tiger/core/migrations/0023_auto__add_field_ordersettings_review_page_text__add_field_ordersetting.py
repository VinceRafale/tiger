...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderSettings.review_page_text'
        db.add_column('core_ordersettings', 'review_page_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'OrderSettings.send_page_text'
        db.add_column('core_ordersettings', 'send_page_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderSettings.review_page_text'
        db.delete_column('core_ordersettings', 'review_page_text')

        # Deleting field 'OrderSettings.send_page_text'
        db.delete_column('core_ordersettings', 'send_page_text')
