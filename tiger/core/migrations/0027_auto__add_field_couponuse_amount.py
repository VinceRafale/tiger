...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CouponUse.amount'
        db.add_column('core_couponuse', 'amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=5, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CouponUse.amount'
        db.delete_column('core_couponuse', 'amount')
