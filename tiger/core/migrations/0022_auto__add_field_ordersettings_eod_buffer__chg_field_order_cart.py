...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_order', 'cart', self.gf('tiger.utils.fields.PickledObjectField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'OrderSettings.eod_buffer'
        db.delete_column('core_ordersettings', 'eod_buffer')
