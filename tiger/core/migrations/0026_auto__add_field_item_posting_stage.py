...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.posting_stage'
        db.add_column('core_item', 'posting_stage', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.posting_stage'
        db.delete_column('core_item', 'posting_stage')
