...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderSettings.payment_type'
        db.add_column('core_ordersettings', 'payment_type', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'OrderSettings.payment_type'
        db.delete_column('core_ordersettings', 'payment_type')
