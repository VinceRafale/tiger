...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LocationStockInfo'
        db.create_table('core_locationstockinfo', (
        ...
        db.send_create_signal('core', ['LocationStockInfo'])


    def backwards(self, orm):
        
        # Deleting model 'LocationStockInfo'
        db.delete_table('core_locationstockinfo')
