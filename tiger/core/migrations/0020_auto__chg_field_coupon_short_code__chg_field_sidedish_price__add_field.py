...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coupon.short_code'
        db.alter_column('core_coupon', 'short_code', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))

        # Changing field 'SideDish.price'
        db.alter_column('core_sidedish', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True))

        # Adding field 'Section.hours'
        db.add_column('core_section', 'hours', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Changing field 'Coupon.short_code'
        db.alter_column('core_coupon', 'short_code', self.gf('django.db.models.fields.CharField')(max_length=20))
        ...
        db.delete_column('core_section', 'hours')
