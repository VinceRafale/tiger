...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.out_of_stock'
        db.add_column('core_item', 'out_of_stock', orm['core.item:out_of_stock'])
        
        # Adding field 'Item.archived'
        db.add_column('core_item', 'archived', orm['core.item:archived'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Item.out_of_stock'
        db.delete_column('core_item', 'out_of_stock')
        
        # Deleting field 'Item.archived'
        db.delete_column('core_item', 'archived')
