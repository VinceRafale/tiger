...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SideDishGroup.section'
        db.add_column('core_sidedishgroup', 'section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Section'], null=True), keep_default=False)
        ...
        # Changing field 'SideDish.price'
        db.alter_column('core_sidedish', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Adding field 'Upgrade.section'
        db.add_column('core_upgrade', 'section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Section'], null=True), keep_default=False)
        ...
        # Adding field 'Variant.section'
        db.add_column('core_variant', 'section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Section'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SideDishGroup.section'
        db.delete_column('core_sidedishgroup', 'section_id')

        # Changing field 'SideDishGroup.item'
        db.alter_column('core_sidedishgroup', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Item']))

        # Changing field 'SideDish.price'
        db.alter_column('core_sidedish', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Deleting field 'Upgrade.section'
        db.delete_column('core_upgrade', 'section_id')

        # Changing field 'Upgrade.item'
        db.alter_column('core_upgrade', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Item']))

        # Deleting field 'Variant.section'
        db.delete_column('core_variant', 'section_id')

        # Changing field 'Variant.item'
        db.alter_column('core_variant', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Item']))
    ...
    models = {
        ...
        'core.sidedishgroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Item']", 'null': 'True'}),
