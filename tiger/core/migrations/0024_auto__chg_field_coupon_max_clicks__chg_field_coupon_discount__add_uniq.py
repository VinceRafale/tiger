...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coupon.max_clicks'
        db.alter_column('core_coupon', 'max_clicks', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))

        # Changing field 'Coupon.discount'
        db.alter_column('core_coupon', 'discount', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Adding unique constraint on 'Coupon', fields ['short_code', 'site']
        db.create_unique('core_coupon', ['short_code', 'site_id'])


    def backwards(self, orm):
        
        # Changing field 'Coupon.max_clicks'
        db.alter_column('core_coupon', 'max_clicks', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

        # Changing field 'Coupon.discount'
        db.alter_column('core_coupon', 'discount', self.gf('django.db.models.fields.IntegerField')())

        # Removing unique constraint on 'Coupon', fields ['short_code', 'site']
        db.delete_unique('core_coupon', ['short_code', 'site_id'])
