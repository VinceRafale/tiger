...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_order', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Location']))


    def backwards(self, orm):
        
        # Changing field 'Order.location'
        db.alter_column('core_order', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Location'], null=True))
