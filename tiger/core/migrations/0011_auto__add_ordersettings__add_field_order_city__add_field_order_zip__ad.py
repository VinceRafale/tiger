...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_order', 'city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Order.zip'
        db.add_column('core_order', 'zip', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'Order.state'
        db.add_column('core_order', 'state', self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'Order.street'
        db.add_column('core_order', 'street', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Changing field 'Order.cart'
        db.alter_column('core_order', 'cart', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_order', 'city')

        # Deleting field 'Order.zip'
        db.delete_column('core_order', 'zip')

        # Deleting field 'Order.state'
        db.delete_column('core_order', 'state')

        # Deleting field 'Order.street'
        db.delete_column('core_order', 'street')

        # Changing field 'Order.cart'
        db.alter_column('core_order', 'cart', self.gf('PickledObjectField')(editable=False))
