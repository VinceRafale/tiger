...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.taxable'
        db.add_column('core_item', 'taxable', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'Order.tax'
        db.add_column('core_order', 'tax', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=6, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderSettings.tax_rate'
        db.delete_column('core_ordersettings', 'tax_rate')

        # Deleting field 'Item.taxable'
        db.delete_column('core_item', 'taxable')

        # Deleting field 'Order.tax'
        db.delete_column('core_order', 'tax')
