...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.price_list'
        db.add_column('core_item', 'price_list', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Item.price_list'
        db.delete_column('core_item', 'price_list')
    ...
    models = {
        ...
        'core.item': {
            ...
            'price_list': ('django.db.models.fields.TextField', [], {'null': 'True'}),
