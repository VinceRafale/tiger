...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.price_list'
        db.alter_column('core_item', 'price_list', self.gf('tiger.utils.fields.PickledObjectField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Item.price_list'
        db.alter_column('core_item', 'price_list', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'core.sidedish': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '5', 'decimal_places': '2'})
        },
        'core.sidedishgroup': {
