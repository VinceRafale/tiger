...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_order', 'location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Location'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_order', 'location_id')
