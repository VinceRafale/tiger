...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_coupon', 'discount')


    def backwards(self, orm):
        
        # Adding field 'Coupon.discount'
        db.add_column('core_coupon', 'discount', self.gf('django.db.models.fields.PositiveIntegerField')(default=2), keep_default=False)
