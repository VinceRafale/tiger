...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.available_online'
        db.add_column('core_item', 'available_online', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.available_online'
        db.delete_column('core_item', 'available_online')
