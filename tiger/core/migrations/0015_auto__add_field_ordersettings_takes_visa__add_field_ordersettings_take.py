...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderSettings.takes_visa'
        db.add_column('core_ordersettings', 'takes_visa', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'OrderSettings.takes_discover'
        db.add_column('core_ordersettings', 'takes_discover', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'OrderSettings.takes_amex'
        db.add_column('core_ordersettings', 'takes_amex', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'OrderSettings.takes_mc'
        db.add_column('core_ordersettings', 'takes_mc', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'OrderSettings.takes_visa'
        db.delete_column('core_ordersettings', 'takes_visa')

        # Deleting field 'OrderSettings.takes_discover'
        db.delete_column('core_ordersettings', 'takes_discover')

        # Deleting field 'OrderSettings.takes_amex'
        db.delete_column('core_ordersettings', 'takes_amex')

        # Deleting field 'OrderSettings.takes_mc'
        db.delete_column('core_ordersettings', 'takes_mc')
