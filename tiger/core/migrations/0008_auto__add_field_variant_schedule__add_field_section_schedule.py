...
class Migration(SchemaMigration):
    depends_on = (
        ("accounts", "0002_auto__add_schedule"),
    )


    def forwards(self, orm):
        
        # Adding field 'Variant.schedule'
        db.add_column('core_variant', 'schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Schedule'], null=True, blank=True), keep_default=False)

        # Adding field 'Section.schedule'
        db.add_column('core_section', 'schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Schedule'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Variant.schedule'
        db.delete_column('core_variant', 'schedule_id')

        # Deleting field 'Section.schedule'
        db.delete_column('core_section', 'schedule_id')
