...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.discount_type'
        db.add_column('core_coupon', 'discount_type', self.gf('django.db.models.fields.PositiveIntegerField')(default=2), keep_default=False)

        # Adding field 'Coupon.dollars_off'
        db.add_column('core_coupon', 'dollars_off', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'Coupon.percent_off'
        db.add_column('core_coupon', 'percent_off', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.discount_type'
        db.delete_column('core_coupon', 'discount_type')

        # Deleting field 'Coupon.dollars_off'
        db.delete_column('core_coupon', 'dollars_off')

        # Deleting field 'Coupon.percent_off'
        db.delete_column('core_coupon', 'percent_off')
    ...
    models = {
        ...
        'core.coupon': {
            ...
            'dollars_off': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2'}),
            ...
            'percent_off': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
