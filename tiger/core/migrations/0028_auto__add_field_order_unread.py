...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.unread'
        db.add_column('core_order', 'unread', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.unread'
        db.delete_column('core_order', 'unread')
    ...
    models = {
        ...
        'content.itemimage': {
            ...
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['content.Gallery']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
