...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hit.location'
        db.alter_column('track_hit', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Location'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Hit.location'
        db.alter_column('track_hit', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.Location']))
