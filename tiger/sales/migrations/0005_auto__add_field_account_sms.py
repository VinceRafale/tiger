...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.sms'
        db.add_column('accounts_account', 'sms', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.SmsSettings'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.sms'
        db.delete_column('accounts_account', 'sms_id')
