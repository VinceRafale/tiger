...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.trial_period'
        db.add_column('accounts_account', 'trial_period', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.trial_period'
        db.delete_column('accounts_account', 'trial_period')
