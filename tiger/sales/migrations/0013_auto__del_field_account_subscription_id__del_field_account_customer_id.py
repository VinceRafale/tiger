...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('accounts_account', 'card_type')

        # Deleting field 'Account.card_number'
        db.delete_column('accounts_account', 'card_number')
    ...
    def backwards(self, orm):
        ...
        db.add_column('accounts_account', 'card_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'Account.card_number'
        db.add_column('accounts_account', 'card_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True), keep_default=False)
