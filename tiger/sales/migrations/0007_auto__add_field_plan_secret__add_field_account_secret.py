...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Plan.secret'
        db.add_column('sales_plan', 'secret', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'Account.secret'
        db.add_column('accounts_account', 'secret', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Plan.secret'
        db.delete_column('sales_plan', 'secret')

        # Deleting field 'Account.secret'
        db.delete_column('accounts_account', 'secret')
