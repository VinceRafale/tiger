...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sales_plan', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2), keep_default=False)

        # Adding field 'Plan.sms_rate'
        db.add_column('sales_plan', 'sms_rate', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Plan.fax_rate'
        db.add_column('sales_plan', 'fax_rate', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Plan.price'
        db.delete_column('sales_plan', 'price')

        # Deleting field 'Plan.sms_rate'
        db.delete_column('sales_plan', 'sms_rate')

        # Deleting field 'Plan.fax_rate'
        db.delete_column('sales_plan', 'fax_rate')
