...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Plan.has_mobile'
        db.add_column('sales_plan', 'has_mobile', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Plan.has_mobile'
        db.delete_column('sales_plan', 'has_mobile')
