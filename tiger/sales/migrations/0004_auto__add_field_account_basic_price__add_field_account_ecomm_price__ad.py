...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.basic_price'
        db.add_column('accounts_account', 'basic_price', self.gf('django.db.models.fields.DecimalField')(default='40.00', max_digits=5, decimal_places=2), keep_default=False)

        # Adding field 'Account.ecomm_price'
        db.add_column('accounts_account', 'ecomm_price', self.gf('django.db.models.fields.DecimalField')(default='67.50', max_digits=5, decimal_places=2), keep_default=False)

        # Adding field 'Account.multi_price'
        db.add_column('accounts_account', 'multi_price', self.gf('django.db.models.fields.DecimalField')(default='85.50', max_digits=5, decimal_places=2), keep_default=False)

        # Adding field 'Account.sms_line_price'
        db.add_column('accounts_account', 'sms_line_price', self.gf('django.db.models.fields.DecimalField')(default='2.00', max_digits=5, decimal_places=2), keep_default=False)

        # Adding field 'Account.sms_price'
        db.add_column('accounts_account', 'sms_price', self.gf('django.db.models.fields.DecimalField')(default='0.02', max_digits=5, decimal_places=2), keep_default=False)

        # Adding field 'Account.fax_price'
        db.add_column('accounts_account', 'fax_price', self.gf('django.db.models.fields.DecimalField')(default='0.07', max_digits=5, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.basic_price'
        db.delete_column('accounts_account', 'basic_price')

        # Deleting field 'Account.ecomm_price'
        db.delete_column('accounts_account', 'ecomm_price')

        # Deleting field 'Account.multi_price'
        db.delete_column('accounts_account', 'multi_price')

        # Deleting field 'Account.sms_line_price'
        db.delete_column('accounts_account', 'sms_line_price')

        # Deleting field 'Account.sms_price'
        db.delete_column('accounts_account', 'sms_price')

        # Deleting field 'Account.fax_price'
        db.delete_column('accounts_account', 'fax_price')
