...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.custom_domain'
        db.add_column('accounts_site', 'custom_domain', orm['accounts.site:custom_domain'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Site.custom_domain'
        db.delete_column('accounts_site', 'custom_domain')
