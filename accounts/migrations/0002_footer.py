...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScheduledUpdate.footer'
        db.add_column('accounts_scheduledupdate', 'footer', orm['accounts.scheduledupdate:footer'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ScheduledUpdate.footer'
        db.delete_column('accounts_scheduledupdate', 'footer')
