...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_site', 'fax_number', orm['accounts.site:fax_number'])
        
        # Adding field 'Site.zip'
        db.add_column('accounts_site', 'zip', orm['accounts.site:zip'])
        
        # Adding field 'Site.street'
        db.add_column('accounts_site', 'street', orm['accounts.site:street'])
        
        # Adding field 'Site.phone'
        db.add_column('accounts_site', 'phone', orm['accounts.site:phone'])
        
        # Adding field 'Site.state'
        db.add_column('accounts_site', 'state', orm['accounts.site:state'])
    ...
    models = {
        ...
        'accounts.site': {
            ...
            'fax_number': ('django.contrib.localflavor.us.models.PhoneNumberField', [], {'default': "''"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
