...
class Migration:
    ...
    def backwards(self, orm):
        ...
        db.create_table('accounts_scheduledupdate', (
            ...
            ('show_descriptions', orm['accounts.scheduledupdate:show_descriptions']),
            ('id', orm['accounts.scheduledupdate:id']),
            ('name', orm['accounts.scheduledupdate:name']),
            ('footer', orm['accounts.scheduledupdate:footer']),
            ('title', orm['accounts.scheduledupdate:title']),
            ('column_height', orm['accounts.scheduledupdate:column_height']),
            ('weekday', orm['accounts.scheduledupdate:weekday']),
            ('columns', orm['accounts.scheduledupdate:columns']),
        ))
