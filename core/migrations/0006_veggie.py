...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.vegetarian'
        db.add_column('core_item', 'vegetarian', orm['core.item:vegetarian'])
        
        # Adding field 'Item.spicy'
        db.add_column('core_item', 'spicy', orm['core.item:spicy'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Item.vegetarian'
        db.delete_column('core_item', 'vegetarian')
        
        # Deleting field 'Item.spicy'
        db.delete_column('core_item', 'spicy')
